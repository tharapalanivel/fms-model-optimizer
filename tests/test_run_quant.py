...
"""Unit Tests for run_quant script."""
...
from tests.artifacts.testdata import (
    ...
    MALFORMATTED_DATA,
    MODEL_NAME,
    WIKITEXT_TOKENIZED_DATA_JSON,
)

MODEL_ARGS = ModelArguments(
    model_name_or_path=MODEL_NAME, torch_dtype="float16", device="cuda"
)
...
def test_run_train_fails_training_data_path_not_exist():
    ...
    with pytest.raises(
        FileNotFoundError
    ):  # TPP Should this be FileNotFoundError or ValueError?
        quantize(
            model_args=MODEL_ARGS,
